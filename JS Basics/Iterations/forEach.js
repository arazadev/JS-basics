...
// -> note we dont add () because we have not to execute the function
...
console.log(item.name, item.file);// access the name properties of the array of the oject
